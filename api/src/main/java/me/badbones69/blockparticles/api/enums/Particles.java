...
public enum Particles {
    ...
    RED_HALO("Red_Halo", ParticleType.PARTICLE),
    ORANGE_HALO("Orange_Halo", ParticleType.PARTICLE),
    PURPLE_HALO("Purple_Halo", ParticleType.PARTICLE),
    GREEN_HALO("Green_Halo", ParticleType.PARTICLE),
